...
$(function(){
    ...
    $('.aboutMe_03').attr("class", "nav-item start active open");
    ...
    $('#submitEditBtn').on('click',function(){
        submitFunction('/type/change')
    })

    $('#submitBtn').on('click',function(){
        submitFunction('/type/insert')
    })
})
            ...
            if(data.code == '0000'){
                ...
                for(var i in result){
                    $("#programId").val(result[i].id),
                        $("#editCompoentClassify").val(result[i].typeParentId)
...
var submitFunction = function (url) {
    ...
    if(url =="/type/insert"){
        $.ajax({
            ...
            dataType: 'json',
            data: {
                typeParentId:$("#addCompoentClassify").val(),
        ...
        $.ajax({
            ...
            data: {
                id:$("#programId").val(),
                typeParentId:$("#editCompoentClassify").val(),
